...
fetch("http://192.168.0.8:3000/api/usuarios/Get_empresas", {
  ...
  .then((data) => {
    ...
    selectAllOption.value = "0"; // Valor para "Seleccionar todas las empresas"
...
estadoSelect.addEventListener("change", function () {
  ...
  if (selectedEmpresa === "0") {
    initializeTable(0, selectedEstado); // Enviar 0 como nombreEmpresa para "Seleccionar todas las empresas"
  } else {
