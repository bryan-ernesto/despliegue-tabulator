...
document.addEventListener("DOMContentLoaded", (event) => {
      ...
      fetch(
        ...
        .then((data) => {
          ...
          if (fechaInicial && fechaFinal) {
            ...
            fetch(
              "http://192.168.0.8:3000/api/reporteador/Get_Reporte_Quejas",
              {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
                ...
                body: JSON.stringify({
                  date_fecha_inicial: "",
                  date_fecha_final: "",
                  str_usuario_responsable: username,
                }),
              }
            )
              .then((response) => response.json())
  ...
  function initializeTable(fechaInicial, fechaFinal) {
    ...
    table = new Tabulator("#example-table", {
      ...
      ajaxURL: "http://192.168.0.8:3000/api/reporteador/Get_Reporte_Quejas",
      ajaxConfig: {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
      ...
      ajaxParams: function (params) {
        return {
          ...
          str_usuario_responsable: usernamequeja,
        };
      },
  ...
  document
    ...
    .addEventListener("click", function () {
      ...
      fetch("http://192.168.0.8:3000/api/reporteador/Get_Reporte_Quejas", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  function exportTable() {
    if (table) {
      const customHeader = {
        v: "REPORTE RECONOCIMIENTOS Y OPORTUNIDADES DE MEJORA",
        s: { font: { sz: 30 } },
      };
