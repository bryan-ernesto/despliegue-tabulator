...
document.addEventListener("DOMContentLoaded", (event) => {
  ...
  document
    ...
    .addEventListener("click", function () {
      ...
      equipoSelect.value = "";
      initializeTable(selectEquipo, selectDepartamento, selectEmpresa, fechaInicial, fechafinal);
    });
          ...
          if (selectedEmpresa) {
            if (selectedDepartamento) {
              if (selectedEquipo) {
                ...
                fetch(
                  "http://192.168.0.8:3000/api/reporteador/Get_Reporte_Tickets_Novales_Servi",
                  {
                    method: "POST",
                    headers: {
                      "Content-Type": "application/json",
  ...
  function initializeTable(equipo, departamento, empresa, fechaInicial, fechaFinal) {
    ...
    table = new Tabulator("#example-table", {
      ...
      ajaxURL: "http://192.168.0.8:3000/api/reporteador/Get_Reporte_Tickets_Novales_Servi",
      ajaxConfig: {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
